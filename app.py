...
if st.session_state.page == 'welcome':
    ...
    <div style='text-align:center;'>
        <p style='font-size:22px;'>🤔 لو انك تشتغل بجهه فيها عملاء، طبيعي يمر عليك عميل يتعامل مع غيرك أو يفكر يترك الخدمة لأي سبب</p>
        <p style='font-size:22px;'>📋 النموذج هذا بيحللك هاللغز، يتعلّم من سلوك العملاء ويعطيك نسبة احتمالية مغادرة كل عميل. ويفكك من التخمين والتوقعات!</p>
        <p style='font-size:22px;'>✅ كل اللي عليك تعبيه كم خيار تحت، وبتشوف النتيجة قدّامك بثواني وبكل وضوح</p>
    </div>
    """, unsafe_allow_html=True)
    st.markdown("---")
